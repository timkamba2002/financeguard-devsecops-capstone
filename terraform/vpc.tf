...
# Single NAT Gateway (to avoid EIP quota issues)
resource "aws_eip" "nat" {
  domain = "vpc"

  tags = {
    Name = "financeguard-nat-${var.environment}"
  }
}
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name = "financeguard-private-rt-${var.environment}"
  }
}
...
resource "aws_route_table_association" "database" {
  ...
  route_table_id = aws_route_table.private.id   # Use private route for DB too
}